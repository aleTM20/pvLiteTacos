...
public static String usuario = "";
     ...
     */
    public Ventas1() throws SQLException {
        initComponents();
...
//        cn.setAutoCommit(false);
     TableColumn columna = tablaVentas.getColumnModel().getColumn(2);
        columna.setMaxWidth(0);
        columna.setMinWidth(0);
        columna.setPreferredWidth(0);
     TableColumn columna2 = tablaVentas.getColumnModel().getColumn(1);
    ...
    private void initComponents() {
        ...
        jTable1.setBorder(javax.swing.BorderFactory.createTitledBorder("MESAS"));
...
//                s.setId_producto(this.tablaVentas.getValueAt(i, 0).toString());
...
//                try {
//                     s.setMesa(Integer.parseInt(this.tablaVentas.getValueAt(i, 6).toString()));
//                int opcion = ventas.Opciones.registrar(s);
//                if (opcion != 0) {
//                    contador++;
//                }
//            String idProducto = this.tablaVentas.getValueAt(i, 0).toString();
//            ArrayList existencias = ventas.Opciones.existencias(idProducto,4);
//            ArrayList cantidadInsumo = ventas.Opciones.cantidadInsumo(idProducto);
//            ArrayList idInsumos = ventas.Opciones.idInsumos(idProducto);
//            for (int j = 0; j < existencias.size(); j++) {
//                float exist = Float.parseFloat(existencias.get(j).toString());
//                float cantInsumo = Float.parseFloat(cantidadInsumo.get(j).toString());
//                String idInsumo = idInsumos.get(j).toString();
//                int cant = Integer.parseInt(this.tablaVentas.getValueAt(i, 3).toString());
//                ventas.Opciones.actualizarExistencias(exist, cantInsumo, idInsumo, cant,"");
//            }
//            
...
//                    ErrorAlert er = new ErrorAlert(new JFrame(), true);
//            er.titulo.setText("OOPS...");
//            er.msj.setText("DEBE INGRESAR EL");
//            er.msj1.setText("NUMERO DE MESA");
//            er.setVisible(true);
//                }
//               
//        }
