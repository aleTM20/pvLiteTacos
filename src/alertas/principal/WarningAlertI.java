...
import insumo.Opciones;

/**
 *
 * @author Rojeru San
 */
public class WarningAlertI extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertI(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertI dialog = new WarningAlertI(new javax.swing.JFrame(), true);
