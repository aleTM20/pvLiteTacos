 ...
 * @author Rojeru San
 */
public class ModalInsumoM extends javax.swing.JDialog {
     ...
     */
    public ModalInsumoM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, -1, -1));

        tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "UNIDAD DE MEDIDA", "KG", "PZA","LTS" }));
        ...
        jPanel4.add(tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 110, 240, 30));
        ...
        jPanel4.add(precio, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 180, 240, 30));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ventas/campo-precio.png"))); // NOI18N
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 170, 320, -1));
        ...
        jPanel4.add(stock, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 240, 30));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/productos/campo_stock.png"))); // NOI18N
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, -1, -1));
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        if (this.nombre.getText().equals("")
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                s.setUnidad_medida(this.tipo.getSelectedItem().toString());
...
//            this.stock.setText("0");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalInsumoM.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalInsumoM dialog = new ModalInsumoM(new javax.swing.JFrame(), true);
