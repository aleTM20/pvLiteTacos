 ...
 * @author Rojeru San
 */
public class ModalInsumoComprar extends javax.swing.JDialog {
     ...
     */
    public ModalInsumoComprar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        stock1 = new app.bolivia.swing.JCTextField();
        ...
        jPanel3.add(limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 160, 50));

        registrar.setBackground(new java.awt.Color(255, 255, 255));
        registrar.setForeground(new java.awt.Color(58, 159, 171));
        registrar.setText("COMPRAR");
        ...
        jPanel3.add(registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 170, 50));

        id.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        id.setForeground(new java.awt.Color(255, 255, 255));
        id.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        id.setText("id");
        jPanel3.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 30, 30, -1));

        panel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, 459, 70));
        ...
        precio.setPlaceholder("PRECIO COMPRA");
        precio.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                precioKeyTyped(evt);
            }
        });
        jPanel4.add(precio, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 240, 30));
        ...
        stock.setPlaceholder("CANTIDAD A COMPRAR");
        stock.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                stockKeyTyped(evt);
            }
        });
        jPanel4.add(stock, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, 240, 30));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/productos/campo_stock.png"))); // NOI18N
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, -1, -1));

        stock1.setEditable(true);
        stock1.setBorder(null);
        stock1.setForeground(new java.awt.Color(58, 159, 171));
        stock1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        stock1.setPlaceholder("CANTIDAD");
        stock1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                stock1KeyTyped(evt);
            }
        });
        jPanel4.add(stock1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 240, 30));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/productos/campo_stock.png"))); // NOI18N
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 330, 270, 90));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(153, 153, 153));
        jLabel1.setText("DESCRIPCIÓN DEL GASTO");
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 290, 220, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/salidas/icono-gasto.png"))); // NOI18N
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, -1, -1));

        panel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 420, 460));

        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 476, 630));
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        if (this.nombre.getText().equals("")
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                s.setInsumo(this.nombre.getText());
...
//                }
                ...
                Sentencias su = new Sentencias();

                s.setDescripcion(this.descripcion.getText());
                
                s.setGastado(Float.parseFloat(this.precio.getText()) * Float.parseFloat(this.stock.getText()));

                su.setIdInsumo(Integer.parseInt(id.getText()));
                float cantidad = Float.parseFloat(this.stock.getText());

//                if (this.tipo.getSelectedIndex() == 2) {
//                } else {
//                    s.setExistencia("");
//                }
                int opcionUpdate = Opciones.actualizarStockCompra(su, cantidad);
...
//                    Insumos.seleccionaFila(fila);
                    SuccessAlert sa = new SuccessAlert(new JFrame(), true);
                    sa.titulo.setText("¡HECHO!");
                    sa.msj.setText("SE HA COMPRADO UNA");
                    sa.msj1.setText("CANTIDAD DE INSUMO");
                    sa.setVisible(true);
                }
            }
        }
...
//                }
    ...
    private void stockKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_stockKeyTyped
        ...
        if ((car < '0' || car >'9') && stock.getText().contains(".") && (car != (char) KeyEvent.VK_BACK_SPACE)) {
            evt.consume();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalInsumoComprar.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalInsumoComprar dialog = new ModalInsumoComprar(new javax.swing.JFrame(), true);
    ...
    public static app.bolivia.swing.JCTextField stock1;
